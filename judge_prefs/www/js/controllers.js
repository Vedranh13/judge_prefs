...
.controller('searchresultsCtrl', function($scope, $rootScope, $state, $ionicModal, $ionicPopup, $firebaseArray) {
      ...
      $scope.viewComments = function() {
        ...
        var ref = new Firebase("https://judge-prefs.firebaseio.com/comments/");
